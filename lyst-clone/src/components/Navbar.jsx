  ...
  return (
    <>
      ...
      <Flex w="96%" m="auto" mb="10px">
        <Center>
          <Image src={logo} width="80%" h="35px" w="100px" cursor={"pointer"} alt='logo' />
          <Spacer></Spacer>
          <Text fontSize='lg' ml="20px" mt="20px" cursor={"pointer"} _hover={{textDecoration:"underline"}} > WOMEN </Text>
          <Text fontSize='lg' ml="10px" mt="20px" cursor={"pointer"} _hover={{textDecoration:"underline"}} > MEN </Text>
        </Center>
        <Spacer></Spacer>
        <Box w="77%" border="1px">
          <InputGroup h="45px">
